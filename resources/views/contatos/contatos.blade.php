...
<head>
    ...
    <!-- TITLE -->
    <title>Contatos - Chicken Steen</title>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6">
                                        <div class="card overflow-hidden">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="mt-2">
                                                        <h6 class="">Total de Contatos</h6>
                                                        <h2 class="mb-0 number-font">{{ $totalContacts }}</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6">
                                        <div class="card overflow-hidden">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="mt-2">
                                                        <h6 class="">Contatos do dia</h6>
                                                        <h2 class="mb-0 number-font">{{ $totalTodayContacts }}</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title mb-0">Lista de Contatos</h3>
                                    </div>
                                                                            ...
                                                                            <tr class="border-bottom">
                                                                                ...
                                                                                <td class="text-left">
                                                                                    <div class="mt-0 mt-sm-2 d-block">
                                                                                        <h6
                                                                                            class="mb-0 fs-14 fw-semibold">
                                                                                            {{ date('d/m/Y H:i:s', strtotime($contact['dt_datecreated'])); }}</h6>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
